  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/home">Home {{ Request::is('/home')? '<span class="sr-only">(current)</span>': ''}}</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/vehiculos">Vehiculos {{ Request::is('/home')? '<span class="sr-only">(current)</span>': ''}}</a>
      </li> 
